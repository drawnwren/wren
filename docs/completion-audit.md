...
| Cross-cutting gates | **Incomplete:** the 77,654 ns p99 / 100,000 ns maximum measurements currently cover the engine plus workspace-composer component, not the full TUI desired-frame path. `wren-latency --gate` fails until App decoration and overlay stages are integrated. Other gates remain A/B1 p99 <2,788,576/347,119 ns; task yield p99/max <62,258/63,969 ns; terminal completion p99 <103,626 ns with no drops; physical key-to-photon <81% of rig baseline; provider p99 <91,859/173,351/202 ns; real-OpenSSH loopback convergence/save p99 <3,958,086/16,004,872 ns; profile-specific netem convergence/save <81% baseline; crash matrix; fuzz/loom jobs. Missing production coverage, hardware, SSH, or authoritative-profile measurements fail their hard gates. | `wren-startup`, `wren-latency`, `wren-system-gates`, conformance, fuzz targets, loom test, `scripts/netem-remote.sh` |
