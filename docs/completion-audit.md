...
| Cross-cutting gates | A/B1 p99 <3,098,418/385,688 ns; desired-frame aggregate p99 <86,283 ns plus per-command gates; task yield p99/max <69,176/71,077 ns; terminal completion p99 <115,141 ns with no drops; physical key-to-photon <90% of rig baseline; provider p99 <102,066/192,613/225 ns; real-OpenSSH loopback convergence/save p99 <4,397,874/17,783,192 ns; profile-specific netem convergence/save <90% baseline; crash matrix; fuzz/loom jobs. Missing hardware, SSH, or authoritative-profile measurements fail their hard gates. | `wren-startup`, `wren-latency`, `wren-system-gates`, conformance, fuzz targets, loom test, `scripts/netem-remote.sh` |
