...
fn client_and_workspace_host_binaries_are_placement_faithful() {
    exercise_host(
        env!("CARGO_BIN_EXE_wren-client-extension-host"),
        HostPlacement::Client,
    );
    exercise_host(
        env!("CARGO_BIN_EXE_wren-workspace-extension-host"),
        HostPlacement::Workspace,
    );
}
